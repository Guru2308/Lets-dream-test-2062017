!(function (t) {
  ...
  405: function (t, e, n) {
    ...
    i.registerAnimation(n(406)),
      i.registerAnimation(n(409)),
      i.registerAnimation(n(181));
  },
  406: function (t, e, n) {
    "use strict";
    function i(t, e) {
  ...
  9600: function (t, e, n) {
    ...
    function o(form, t) {
      var e = form.find(".u-slide"),
        n = e.filter(".u-active, .active");
      if (void 0 === t) t = e.index(n);
      var i = form.find(".u-btn-submit, .u-btn-step"),
        o = i.filter(".u-btn-submit"),
        a = i.filter(".u-btn-step-next"),
        s = i.filter(".u-btn-step-prev");
