...
<head>
  ...
  <link rel="stylesheet" href="Mentor-Dashboard.css" media="screen" />
  ...
  <script type="application/ld+json">
    {
      ...
      "@type": "Organization",
      "name": "Lets-dream-Mentor-dashboard"
    }
  </script>
  <meta name="theme-color" content="#478ac9" />
  <meta property="og:title" content="Mentor-Dashboard" />
...
<body data-home-page="index.php" data-home-page-title="Mentor-Dashboard" class="u-body u-stick-footer u-xl-mode" data-lang="en">
  <header class="u-box-shadow u-clearfix u-header u-header" id="sec-bc06">
    <div class="u-clearfix u-sheet u-sheet-1">
      ...
      <h3 class="u-custom-font u-font-montserrat u-hover-feature u-text u-text-default u-text-1">
        Mentor Dashboard<span style="font-weight: 700"></span>
      </h3>
  ...
  <section class="u-align-center u-clearfix u-custom-color-6 u-section-1" id="sec-4e0c">
    <div class="u-clearfix u-sheet u-valign-bottom u-sheet-1">
      <div class="u-expanded-width u-tabs u-tabs-1">
        <ul class="u-tab-list u-unstyled" role="tablist">
          <li class="u-tab-item" role="presentation">
            <a class="active u-active-custom-color-1 u-button-style u-custom-font u-font-montserrat u-tab-link u-text-body-alt-color u-tab-link-1" id="link-tab-0da5" href="#tab-0da5" role="tab" aria-controls="tab-0da5" aria-selected="true">Mentee List</a>
          </li>
          <li class="u-tab-item" role="presentation">
            <a class="u-active-custom-color-1 u-button-style u-custom-font u-font-montserrat u-tab-link u-text-body-alt-color u-tab-link-2" id="link-tab-14b7" href="#tab-14b7" role="tab" aria-controls="tab-14b7" aria-selected="false">Assignments</a>
          </li>
          <li class="u-tab-item" role="presentation">
            <a class="u-active-custom-color-1 u-button-style u-custom-font u-font-montserrat u-tab-link u-text-body-alt-color u-tab-link-3" id="link-tab-2917" href="#tab-2917" role="tab" aria-controls="tab-2917" aria-selected="false">Meeting</a>
          </li>
        </ul>
        <div class="u-tab-content">
          <div class="u-container-style u-custom-color-1 u-hover-feature u-shape-rectangle u-tab-active u-tab-pane u-tab-pane-1" id="tab-0da5" role="tabpanel">
            <div class="u-container-layout u-container-layout-1">
              ...
              <!-- Table for Displaying list of metees -->
              <table class="table table-bordered">
                ...
                <!-- mentee list on tbody  -->
                <tbody>
                  <div class="mentee_php">
                    <?php include 'db_connection/name_output.php' ?>
                  </div>
                </tbody>
              </table>
            ...
            <div class="u-container-layout u-container-layout-2">
              <div class="u-form u-form-1">
                <form action="assignment.php" method="post" onSubmit="alert('Assigned Successfully.');" >
                  ...
                  <input type="hidden" name="formServices" value="9cb7b39f5f39555ed0b0bf702bd00cde" />
                </form>
              </div>
            </div>
          </div>
          <div class="u-container-style u-custom-color-1 u-hover-feature u-shape-rectangle u-tab-pane u-tab-pane-3" id="tab-2917" role="tabpanel">
            <div class="u-container-layout u-container-layout-3">
              <h4 class="u-custom-font u-font-montserrat u-text u-text-default u-text-2">
                Start a meeting with Mentees
              </h4>
              <img class="u-image u-image-contain u-image-default u-image-1" src="images/2560px-Google_Meet_text_logo_2020.svg.png" alt="" data-image-width="2560" data-image-height="497" />
              <a href="https://meet.google.com/new?hs=180&amp;amp;authuser=0" class="u-btn u-btn-round u-button-style u-custom-color-7 u-custom-font u-font-montserrat u-hover-feature u-btn-5" target="_blank">Start meeting</a>
              <p class="u-custom-font u-font-montserrat u-hover-feature u-text u-text-default u-text-3">
                UserID : chatheriyan2308@gmail.com<br />Password :
                3dfuefe565ntnjwAjR23iop
              </p>
              <img class="u-expanded-height u-image u-image-default u-image-2" src="https://cdn.pixabay.com/photo/2018/03/10/12/00/teamwork-3213924_1280.jpg" alt="no internet" data-image-width="1280" data-image-height="807" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content text-dark">
          ...
          <div class="modal-body">
            <div class="h5">
              Name:
              <span class="model_name font-weight-normal">Ferrari John</span>
            </div>
            <div class="h5">
              Course Name:
              <span class="model_course font-weight-normal">Java</span>
            </div>
            <div class="h5">
              Mail ID:
              <span class="model_mail font-weight-normal">ferrari.john@christuniversity.in</span>
            </div>
            <div class="multiple_bar mt-3">
              ...
              <div class="progress">
                <div class="progress-bar bg-success as-1" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
                  34
                </div>
              </div>
              <div class="text-dark">
              ...
              <div class="progress">
                <div class="progress-bar bg-info as-2" role="progressbar" style="width: 50%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">
                  34
                </div>
              </div>
              <div class="text-dark">
              ...
              <div class="progress">
                <div class="progress-bar bg-warning as-3" role="progressbar" style="width: 75%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">
                  23
                </div>
              </div>
              <div class="text-dark">
              ...
              <div class="progress">
                <div class="progress-bar bg-danger as-4" role="progressbar" style="width: 100%" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100">
                  23
                </div>
              </div>
            </div>
...
<div id="chat-circle" class="btn btn-raised">
  ...
  <footer class="u-align-center u-clearfix u-custom-color-6 u-footer u-footer" id="sec-3ba2">
    <div class="u-clearfix u-sheet u-sheet-1"></div>
  </footer>
  <script type="text/javascript" src="../dhanasekar_progress/modal.js"></script>
</body>
